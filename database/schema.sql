CREATE TABLE sys_role (
    ...
    action_permissions VARCHAR(2000),
...
CREATE TABLE governance_flow (
    ...
    operator_chain VARCHAR(4000) NOT NULL,
...
CREATE TABLE task_log (
    ...
    execution_steps VARCHAR(4000),
    failure_reason VARCHAR(4000),
    duration BIGINT DEFAULT 0,
    operator_user BIGINT,
    create_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_task_log_task FOREIGN KEY (task_id) REFERENCES task_def(task_id)
);
