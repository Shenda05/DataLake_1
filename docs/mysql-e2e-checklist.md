...
如默认 Java 版本不是 `17+`，先切换到本机可用的 JDK 17（或更高）后再启动：
...
- 确认脚本已覆盖数据库 Schema、表导入、`xlsx` 导出、日志回放和权限实时同步。
...
- 最新冻结状态确认日期：`2026-04-04`
- 最近一次 MySQL 真实联调执行日期：`2026-03-27`
